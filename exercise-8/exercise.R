...
pulitzer['Pulitzer.Prize.Change'] = select(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014) - select(pulitzer, Pulitzer.Prize.Winners.and.Finalists..1990.2003)

# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 

var = filter(pulitzer,Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014) ) 
...
de = filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>% filter(pulitzer, Change.in.Daily.Circulation..2004.2013 == min(Change.in.Daily.Circulation..2004.2013))
